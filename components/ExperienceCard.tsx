...
function ExperienceCard({ companyName, jobTitle, imageUrl, dateEnded, dateStarted, tasks }: Props) {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-2 md:space-y-3 flex-shrink-0 w-[300px] md:w-[350px] h-[480px] md:h-[520px] xl:w-[600px] snap-center bg-[#474787]/60 p-4 opacity-40 hover:opacity-100 cursor-pointer gap-2 transition-opacity duration-200 overflow-hidden'>
        {/* image of company */}
